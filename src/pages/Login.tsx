  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <img 
          src="https://source.unsplash.com/random/1200x900/?nature,sustainability,green" 
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-eco-forest/70 to-transparent flex items-center">
          <div className="px-12 max-w-lg">
            <h1 className="text-4xl font-bold text-white mb-6">Welcome Back to Eco Fiesta</h1>
            <p className="text-white/90 text-lg">
              Continue your journey to create sustainable, eco-friendly events that make a difference.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 bg-white dark:bg-eco-forest/5">
        <div className="max-w-md w-full">
          ...
          <div className="mb-8 text-center lg:text-left">
            <h2 className="text-3xl font-bold text-eco-forest dark:text-white">Log In</h2>
            <p className="text-gray-600 dark:text-gray-300 mt-2">
              Don't have an account? <Link to="/signup" className="text-eco-leaf hover:underline">Sign Up</Link>
            </p>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <a href="#" className="text-eco-leaf hover:underline">Terms of Service</a>{' '}
            and{' '}
            <a href="#" className="text-eco-leaf hover:underline">Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
